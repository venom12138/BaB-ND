import os, sys
file_parent_dir = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
import copy
import time
import numpy as np
import transforms3d
...
class KinHelper():
    def __init__(self, robot_name="xarm6", headless=True):
        ...
        # load robot
        assert robot_name == 'xarm6'
        urdf_path = f"{file_parent_dir}/robots/xarm6_no_gripper/xarm6.urdf"
        self.eef_name = 'link6'
        ...
        # copy variables
        self.package_dir = file_parent_dir
