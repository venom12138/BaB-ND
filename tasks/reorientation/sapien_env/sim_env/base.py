...
from tasks.reorientation.sapien_env.sim_env.constructor import get_engine_and_renderer, add_default_scene_light
...
class BaseSimulationEnv(object):
    def __init__(self, use_gui=True, frame_skip=5, use_visual_obs=False, no_rgb=False, need_offscreen_render=False, use_ray_tracing=False,
        ...
        self.contact_map_size = [16,16]
        self.previous_contact_map_left = np.zeros((self.contact_map_size[0], self.contact_map_size[1]))
        self.previous_contact_map_right = np.zeros((self.contact_map_size[0], self.contact_map_size[1]))
        self.alpha = 0.9
